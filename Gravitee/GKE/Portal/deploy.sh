...
sed -i -e "s|GRAVITEE_PORTAL_REPLICAS_QTY|${GRAVITEE_PORTAL_REPLICAS_QTY}|g" ./deployment-ui.yaml

# Deploy...
kubectl create -f ./ui-config.yaml
kubectl create -f deployment-ui.yaml
kubectl create -f expose-gravitee-ui.yaml
