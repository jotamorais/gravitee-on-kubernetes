...
**Note:** The [shell script](scripts/generate.sh) has been modified to automate all the steps described bellow. Additionally, a new Mongo application user is created and also a Kubernetes Service to expose Mongo replicas outside of the cluster it's running at through a Load Balancer.
...
--
## This repository is a fork of [Paul Done's](https://github.com/pkdone/gke-mongodb-shards-demo) work. Kudos to him.
